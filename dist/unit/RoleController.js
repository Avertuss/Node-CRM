...
function default_1(roleServise, path) {
    router.get("/role", isPemite(base_1.LVL.READ, 'role'), function (req, res, next) {
    ...
    router.get("/role/:id", isPemite(base_1.LVL.READ, 'role'), function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    router.post("/role", isPemite(base_1.LVL.UPDATE, 'role'), function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
    ...
    router.patch("/role/:id", isPemite(base_1.LVL.UPDATE, 'role'), function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
    ...
    return router["delete"]("/role/:id", isPemite(base_1.LVL.DELETE, 'role'), function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
